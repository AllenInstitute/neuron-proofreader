...
def topological_decomposition(subgraph, root=0):
    ...
    (root, branch points, leaves), for embedding with CurveEncoder.

    Parameters
    ----------
    subgraph : SkeletonGraph
        Rooted subgraph, as returned by "rooted_subgraph".
    root : int, optional
        Node ID of subgraph root. Default is 0.
